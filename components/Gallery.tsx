      ...
      <div className="container mx-auto px-4">
            ...
            <button
              ...
              className={`
                ...
                ${selectedCategory === category
                  ...
                  : 'bg-bg-muted text-text-body hover:bg-border-default'
                }
              `}
            >
              {category}
        ...
        >
          <Link href="https://www.instagram.com/victoriablushcollections" target="_blank" className="inline-block">
            <div className="inline-flex items-center gap-4 bg-linear-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer">
              ...
              <div className="text-left">
                <p className="text-sm opacity-90">Follow me on Instagram</p>
                <p className="font-bold">@victoriablushcollections</p>
              </div>
            </div>
          </Link>
        </motion.div>
